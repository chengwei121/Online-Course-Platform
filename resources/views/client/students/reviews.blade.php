                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center">
                            <p class="text-2xl font-bold text-gray-900">{{ $averageRating ? number_format($averageRating, 1) : '0.0' }}</p>
                            <div class="flex items-center ml-2">
                                @for ($i = 1; $i <= 5; $i++)
                                    <svg class="w-5 h-5 {{ $averageRating >= $i ? 'text-yellow-400' : 'text-gray-300' }}" 
