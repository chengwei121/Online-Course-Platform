                            ...
                            <div class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 h-[480px] flex flex-col">
                                ...
                                <div class="relative h-[200px] flex-shrink-0">
                                    ...
                                    @php
                                        ...
                                        $defaultImg = 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80';
                                    @endphp
                                    <img src="{{ $thumbnailSrc ?? $defaultImg }}" 
                                         alt="{{ $course->title }}" 
                    ...
                    <div class="group bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300 fade-in-up w-full">
                        <div class="relative h-[380px] overflow-hidden flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
                            @php
                                ...
                                $fallbackImg = 'https://ui-avatars.com/api/?name=' . urlencode($instructor->name) . '&size=400&background=random';
                            @endphp
                    ...
                    <div class="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 fade-in-up {{ $index > 0 ? 'fade-in-delay-' . ($index * 100) : '' }}">
                        <div class="flex items-center mb-6">
                            @php
                                ...
                                $avatarFallback = 'https://ui-avatars.com/api/?name=' . urlencode($testimonial->user->name) . '&background=random';
                                $avatarSrc = $avatar ? asset('storage/' . $avatar) : $avatarFallback;
                            @endphp
