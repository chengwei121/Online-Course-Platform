...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <!-- Course Actions -->
            <div class="card mb-3 shadow border-0" style="background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%);">
                <div class="card-header border-0" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%);">
                    <h5 class="card-title mb-0 text-white fw-bold">
                        <i class="fas fa-cogs me-2"></i>Course Management
                    </h5>
                </div>
                <div class="card-body" style="background: linear-gradient(135deg, #f1f8e9 0%, #dcedc8 100%);">
                    <div class="d-grid gap-3">
                        <form method="POST" action="{{ route('admin.courses.toggle-status', $course) }}">
                            @csrf
                            @method('PATCH')
                            <button type="submit" class="btn btn-{{ $course->status == 'published' ? 'warning' : 'success' }} w-100 py-3 fw-bold shadow-sm">
                        ...
                        @if($course->enrollments->count() == 0)
                            <button type="button" class="btn btn-danger w-100 py-2 fw-bold shadow-sm" onclick="confirmDelete()">
